function Querylevelnorm = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   QUERYLEVELNORM = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   QUERYLEVELNORM = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Querylevelnorm = importfile('Querylevelnorm.txt', 1, 69623);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/10/12 13:23:03
